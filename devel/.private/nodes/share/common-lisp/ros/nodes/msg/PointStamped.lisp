...
(cl:defclass <PointStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (point
    :reader point
    :initarg :point
    :type nodes-msg:Point
    :initform (cl:make-instance 'nodes-msg:Point)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-msg:<PointStamped> is deprecated: use nodes-msg:PointStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PointStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-msg:header-val is deprecated.  Use nodes-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <PointStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-msg:point-val is deprecated.  Use nodes-msg:point instead.")
  (point m))
